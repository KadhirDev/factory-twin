...
import { Activity, Cpu, AlertTriangle, WifiOff } from "lucide-react";
      ...
      <div className="px-5 pb-4">
        <div className="flex justify-between mb-1">
          ...
          <div className="flex gap-2">
            ...
            {temp != null && (
              <span className="text-xs font-mono">{temp.toFixed(1)}°C</span>
            )}
          </div>
        </div>
...
export default function Dashboard() {
  ...
  const { data: machines = [], loading, error, refresh } = usePolling(
    fetchFn,
    REFRESH_MS
  );
  ...
  return (
    <div className="p-6 max-w-screen-xl mx-auto">
      ...
      {safeMachines.length > 0 && (
        <FleetAnomalySummary machines={safeMachines} />
      )}
